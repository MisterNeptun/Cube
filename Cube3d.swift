...
class RubiksCubeNode: SCNNode {
    ...
    private func colorForIndex(_ index: Int) -> NSColor {
        switch index {
        case 0: return .white   // Front
        case 1: return .green   // Bottom
        case 2: return .blue    // Top
        case 3: return .yellow  // Back
        case 4: return .orange  // Left
        case 5: return .red     // Right
        default: return .gray
        }
    }
    ...
    func L_clockwise_model() {
        ...
        let action = SCNAction.rotateBy(x:  .pi/2, y:0, z: 0, duration: 2)
        rotationNode.runAction(action) {
